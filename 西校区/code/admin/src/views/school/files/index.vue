        ...
        <el-col :span="18"
          ...
          <el-form-item>
            <el-form-item label="所属学校"
                          prop="school_no">
              <cms-select v-model="formSearch.school_no"
                          ref="level1"
...
export default {
  ...
  methods: {
    ...
    GetData () {
      ...
      that.loading = true
      that.$api
        .SCHOOL_FILE_LIST(that.formSearch)
        .then(function (res) {
