    ...
    <el-form :inline="true"
      ...
      <el-row>
        ...
        <el-col :span="16"
          ...
          <el-form-item>
            <el-form-item>
              <cms-select v-model="formSearch.activity_no"
                          ref="level1"
                          v-bind:action="'/Activity/Select'"
...
export default {
  ...
  methods: {
    selectOption (val) {
      const that = this
      that.formSearch.activity_no = val
      that.doSearch()
    },
    doSearch: function () {
      const that = this
