<template>
  <d2-container>
    <el-form :inline="true"
      ...
      <el-row>
        <el-col :span="16"
                style="height:25px;">
          <el-form-item>
            <el-radio-group v-model="formSearch.state"
    ...
    <el-table ref="multipleTable"
      ...
      <el-table-column prop="banner_title"
                       label="标题"
                       width="150"
                       show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="html_url"
                       label="url"
                       show-overflow-tooltip>
      </el-table-column>
      ...
      <el-table-column label="状态"
        ...
        <template slot-scope="scope">
          <cms-state ref="comswitch"
                     ...
                     v-bind:action="'/Banner/state?recordId=' + scope.row.id"></cms-state>
        </template>
      </el-table-column>
