<template>
  <el-drawer :title="title"
    ...
    <el-form :model="dataForm"
      ...
      <template v-for="(item,index) in dataForm.resume">
    ...
    <div slot="title"
      ...
      <div style="float:right;">
        ...
        <el-button type="success"
                   size="mini"
                   v-on:click="doAdd()"
                   :loading="loading">增加履历</el-button>
...
export default {
  ...
  methods: {
    ...
    doDel (row, index) {
      const that = this
      var idx = that.dataForm.resume.indexOf(row)
      that.dataForm.resume.splice(idx, 1)
    },
    selectOption (val) {
