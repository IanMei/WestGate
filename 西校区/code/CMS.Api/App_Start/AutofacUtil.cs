...
namespace  ElementUI.Admin
{
    public class AutofacUtil
    {
        ...
        public static void InitAutofac()
        {
            ...
            //注入service
            builder.RegisterAssemblyTypes(Assembly.Load("CMS.IService"), Assembly.Load("CMS.Service"))
                   .Where(x => x.Name.EndsWith("Service"))
                   .AsImplementedInterfaces();
            ////注入repository
            //builder.RegisterAssemblyTypes(Assembly.Load("CMS.Responsity"), Assembly.Load("CMS.Responsity"))
