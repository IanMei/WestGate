...
namespace ElementUI.Admin.Areas.Admin.Controllers.Account
{
    ...
    public class ChooseUsController : BaseApiController
    {
        private readonly IChooseusService service;

        public ChooseUsController(IChooseusService _service)
        {
            service = _service;
        }
        ...
        /// <returns></returns>
        [HttpGet, ApiPermission(OperationCode = "200010030")]
        ...
        /// <returns></returns>
        [HttpGet, ApiPermission(OperationCode = "200010032")]
        ...
        [HttpPost, ApiPermission(OperationCode = "2000210031|200010032")]
        public ApiResult UpdateData([FromBody] AboutDto request)
        {
        ...
        /// <returns></returns>
        [HttpGet, ApiPermission(OperationCode = "200010033")]
