...
namespace ElementUI.Admin.Areas.Admin.Controllers.Account
{
    ...
    public class AboutUsController : BaseApiController
    {
        ...
        public AboutUsController(IAboutService _service)
        {
            service = _service;
        }
        ...
        /// <returns></returns>
        [HttpGet, ApiPermission(OperationCode = "200020030")]
        ...
        /// <returns></returns>
        [HttpGet, ApiPermission(OperationCode = "200020032")]
        ...
        [HttpPost, ApiPermission(OperationCode = "200020031|200020032")]
        ...
        /// <returns></returns>
        [HttpGet, ApiPermission(OperationCode = "200020033")]
