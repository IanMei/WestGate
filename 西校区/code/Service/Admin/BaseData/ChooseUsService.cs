...
{
    public class ChooseUsService : IChooseusService
    {
        private string aboutType = "01";
        private IBaseRepository<SqlServercfg> bll;
        public ChooseUsService(IBaseRepository<SqlServercfg> _bll)
        {
            bll = _bll;
        }
        ...
        public ApiResult Update(AboutDto form)
        {
            ...
            {
                item.ABOUT_NO = bll.GetSeqNo("CHN");
