  ...
  <div class="houtai_right_mid pc">
    ...
    <div class="wap">
      <div class="houtai_real_top">
        ...
        <span style="margin-top:10px">您好，{{info.nick_name}}</span>
      ...
      <div class="my_file_phone">
        <div class="someone">
          <ul>
            <li class="xz">
              <router-link to="/judges/wap/account">账号管理</router-link>
            </li>
          </ul>
        </div>
        <div class="someone">
          <ul>
            <li>
              <router-link to="/judges/wap/change">变更手机</router-link>
            </li>
          </ul>
        </div>
        <div class="someone">
          <ul>
            <li>
              <router-link to="/judges/mine/info">信息维护</router-link>
            </li>
          </ul>
        </div>
        <div class="someone">
          <ul>
            <li>
              <router-link to="/judges/mine/questionnaire">问卷审核</router-link>
            </li>
          </ul>
        </div>
        <div class="someone">
          <ul>
            <li>
              <router-link to="/judges/wap/help">帮助中心</router-link>
            </li>
          </ul>
        </div>
        <div class="someone">
          <ul>
            <li>
              <router-link to="/judges/wap/feedback">意见反馈</router-link>
            </li>
          </ul>
        </div>
      </div>
...
export default {
  ...
  created () {
    this.$store.commit('setJudgesTab', 0)
  },
  ...
  methods: {
    ...
    sendSms () {
      ...
      api
        .GET('/Judges/SendChangeMobileSms', that.changeForm)
        .then(function (res) {
    ...
    changeMobile () {
      const that = this
      api
        .POST('/Judges/ChangeMobile', that.changeForm)
        .then(function (res) {
